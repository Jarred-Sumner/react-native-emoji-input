...
const category = [
  ...
  },
  {
    key: "activity",
    title: "Activity",
    icon: props => <Icon name="football" type="material-community" {...props} />
  },
  {
...
class EmojiInput extends PureComponent {
  ...
  _rowRenderer(type, data) {
    const { TextComponent, TextInputComponent } = this.props;
      ...
      >
        ...
        {this.state.emptySearchResult && (
          <View style={styles.emptySearchResultContainer}>
            <TextComponent>No search results.</TextComponent>
          </View>
        )}
        <RecyclerListView
          style={{ flex: 1 }}
